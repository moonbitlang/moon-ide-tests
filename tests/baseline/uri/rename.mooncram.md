...
```mooncram
$ run_moon_ide moon ide rename 'Uri' UriRenamed
*** Begin Patch
*** Update File: <WORKDIR>/uri.mbt
@@
 /// - path: hierarchical path to resource
...
```mooncram
$ run_moon_ide moon ide rename 'Authority' AuthorityRenamed
*** Begin Patch
*** Update File: <WORKDIR>/uri.mbt
@@
 /// - fragment: reference to a secondary resource
...
```mooncram
$ run_moon_ide moon ide rename 'UriError' UriErrorRenamed
*** Begin Patch
*** Update File: <WORKDIR>/uri.mbt
@@
...
```mooncram
$ run_moon_ide moon ide rename 'empty' empty_renamed
...
```mooncram
$ run_moon_ide moon ide rename 'parse_with_scheme' parse_with_scheme_renamed
*** Begin Patch
*** Update File: <WORKDIR>/uri.mbt
@@
