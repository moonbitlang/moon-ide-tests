...
```mooncram
$ run_moon_ide moon ide rename JsonArray JsonArrayRenamed --loc 'src/lib/decode.mbt:2:10'
*** Begin Patch
*** Update File: <WORKDIR>/src/lib/decode.mbt
@@
 ///|
-pub type JsonArray = Array[Json]
+pub type JsonArrayRenamed = Array[Json]
...
+  array_start(Self, JsonArrayRenamed) -> JsonArrayRenamed
-  array_push(Self, Json, JsonArray) -> JsonArray
+  array_push(Self, Json, JsonArrayRenamed) -> JsonArrayRenamed
-  array_finish(Self, JsonArray, JsonArray) -> (JsonArray, JsonArray)
+  array_finish(Self, JsonArrayRenamed, JsonArrayRenamed) -> (JsonArrayRenamed, JsonArrayRenamed)
...
+impl Decode for Unit with array_start(_self, _old_acc) -> JsonArrayRenamed {
   []
 }
...
```mooncram
$ run_moon_ide moon ide rename JsonObject JsonObjectRenamed --loc 'src/lib/decode.mbt:5:10'
*** Begin Patch
*** Update File: <WORKDIR>/src/lib/decode.mbt
@@
 pub type JsonArray = Array[Json]
 ...
 ///|
-pub type JsonObject = Map[String, Json]
+pub type JsonObjectRenamed = Map[String, Json]
...
@@
   ...
   array_finish(Self, JsonArray, JsonArray) -> (JsonArray, JsonArray)
-  object_start(Self, JsonObject) -> JsonObject
+  object_start(Self, JsonObjectRenamed) -> JsonObjectRenamed
-  object_push(Self, String, Json, JsonObject) -> JsonObject
+  object_push(Self, String, Json, JsonObjectRenamed) -> JsonObjectRenamed
-  object_finish(Self, JsonObject, JsonObject) -> (JsonObject, JsonObject)
+  object_finish(Self, JsonObjectRenamed, JsonObjectRenamed) -> (JsonObjectRenamed, JsonObjectRenamed)
...
+impl Decode for Unit with object_start(_self, _old_acc) -> JsonObjectRenamed {
   Map([])
 }
...
```mooncram
$ run_moon_ide moon ide rename json json_renamed --loc 'src/tests/top.mbt:2:7'
...
```mooncram
$ run_moon_ide moon ide rename 'Context' ContextRenamed
...
```mooncram
$ run_moon_ide moon ide rename 'Frame' FrameRenamed
*** Begin Patch
*** Update File: <WORKDIR>/src/lib/json.mbt
@@
   skip : Int
...
```mooncram
$ run_moon_ide moon ide rename 'decode' decode_renamed
...
```mooncram
$ run_moon_ide moon ide rename 'decode_start' decode_start_renamed
...
```mooncram
$ run_moon_ide moon ide rename 'decode_continue' decode_continue_renamed
...
```mooncram
$ run_moon_ide moon ide rename 'value' value_renamed
*** Begin Patch
*** Update File: <WORKDIR>/src/lib/json.mbt
@@
     stack: [],
