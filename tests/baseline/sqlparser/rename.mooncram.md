...
```mooncram
$ run_moon_ide moon ide rename 'structural_print' 'structural_print_renamed' --loc 'src/ast.mbt:7:18'
*** Begin Patch
*** Update File: <WORKDIR>/src/ast.mbt
@@
 }
...
```mooncram
$ run_moon_ide moon ide rename 'Statements' 'StatementsRenamed' --loc 'src/ast.mbt:12:17'
*** Begin Patch
*** Update File: <WORKDIR>/src/ast.mbt
@@
 }
...
```mooncram
$ run_moon_ide moon ide rename 'pretty' 'pretty_renamed' --loc 'src/ast.mbt:18:41'
*** Begin Patch
*** Update File: <WORKDIR>/src/ast.mbt
@@
 } derive(Eq, Debug)
