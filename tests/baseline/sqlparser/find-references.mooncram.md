...
```mooncram
$ run_moon_ide moon ide find-references 'structural_print' --loc 'src/ast.mbt:7:18'
...
```mooncram
$ run_moon_ide moon ide find-references 'Statements' --loc 'src/ast.mbt:12:17'
...
```mooncram
$ run_moon_ide moon ide find-references 'pretty' --loc 'src/ast.mbt:18:41'
Found 1 references for symbol 'pretty':
