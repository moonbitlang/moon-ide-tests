...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide hover 'Reverse' --loc 'cmp\cmp.mbt:35:17'
/// }
/// ```
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide hover 'T' --loc 'cmp\cmp.mbt:35:28'
/// }
/// ```
#warnings("-deprecated_syntax")
pub(all) struct Reverse[T](T) derive(Eq, Show, Hash, @debug.Debug)
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide hover 'args' --loc 'env\env.mbt:17:8'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide hover 'get_cli_args_internal' --loc 'env\env.mbt:18:3'
///|
/// Get the command line arguments passed to the program.
pub fn args() -> Array[String] {
  get_cli_args_internal()
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide hover 'get_cli_args_internal' --loc 'env\env_js.mbt:16:16'
No hover information found for symbol 'get_cli_args_internal' at env\env_js.mbt:16:16
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide hover 'now_internal' --loc 'env\env_js.mbt:26:16'
No hover information found for symbol 'now_internal' at env\env_js.mbt:26:16
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide hover 'args' --loc 'env\env_test.mbt:17:7'
///|
test {
  let args = @env.args()
      ^^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide hover 'args' --loc 'env\env_test.mbt:17:19'
///|
test {
  let args = @env.args()
             ^^^^^^^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide hover 'begin_create_string' --loc 'env\env_wasm.mbt:28:4'
No hover information found for symbol 'begin_create_string' at env\env_wasm.mbt:28:4
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide hover 'XStringCreateHandle' --loc 'env\env_wasm.mbt:28:29'
