...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'arr' --loc 'builtin\exact_view_test.mbt:17:7'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'fixed' --loc 'builtin\exact_view_test.mbt:18:7'
Definition found at file <WORKDIR>/builtin\exact_view_test.mbt
   | // limitations under the License.
   | 
   | ///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'self' --loc 'builtin\int64.mbt:26:21'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'from_int' --loc 'builtin\int64.mbt:44:15'
Definition found at file <WORKDIR>/builtin\int64.mbt
   | /// ```mbt check
   | /// test {
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'ToStringView' --loc 'builtin\string_like.mbt:19:11'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'to_string_view' --loc 'builtin\string_like.mbt:20:6'
Definition found at file <WORKDIR>/builtin\string_like.mbt
   | ///|
   | /// Trait for values that can be viewed as `StringView`.
   | ///
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'decode_utf8_js' --loc 'encoding\utf8\decode_js.mbt:16:16'
Error: could not get package of loc encoding\utf8\decode_js.mbt:16:16
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'bytes' --loc 'encoding\utf8\decode_js.mbt:17:3'
Error: could not get package of loc encoding\utf8\decode_js.mbt:17:3
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'ThreadSet' --loc 'internal\regex_engine\automata\thread_set.mbt:46:11'
Definition found at file <WORKDIR>/internal\regex_engine\automata\thread_set.mbt
   | /// # Usage in Automaton
   | ///
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'Empty' --loc 'internal\regex_engine\automata\thread_set.mbt:47:3'
Definition found at file <WORKDIR>/internal\regex_engine\automata\thread_set.mbt
   | ///
   | /// During execution, each `State` contains a `ThreadSet` collection representing all
   | /// possible execution paths from that state. When computing the derivative with
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'LazyState' --loc 'lazy\lazy.mbt:24:11'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'Unforced' --loc 'lazy\lazy.mbt:25:3'
Definition found at file <WORKDIR>/lazy\lazy.mbt
   | ///   `force` calls on the same cell, which would otherwise re-evaluate
   | ///   the thunk and silently break the at-most-once guarantee.
   | /// - `Forced(v)`: the thunk has produced `v`; the thunk reference is
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'Regex' --loc 'string\internal\regex_engine\regex.mbt:16:8'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'profile' --loc 'string\internal\regex_engine\regex.mbt:17:3'
Definition found at file <WORKDIR>/string\internal\regex_engine\regex.mbt
   | // See the License for the specific language governing permissions and
   | // limitations under the License.
   | 
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'regex' --loc 'string\regex_test.mbt:17:7'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'execute' --loc 'string\regex_test.mbt:18:15'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'Test' --loc 'test\types.mbt:16:8'
Definition found at file <WORKDIR>/test\types.mbt
   | // WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied.
   | // See the License for the specific language governing permissions and
   | // limitations under the License.
   | 
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'name' --loc 'test\types.mbt:17:3'
Definition found at file <WORKDIR>/test\types.mbt
   | // See the License for the specific language governing permissions and
   | // limitations under the License.
   | 
