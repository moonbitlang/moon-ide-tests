...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'Reverse' --loc 'cmp\cmp.mbt:35:17'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'T' --loc 'cmp\cmp.mbt:35:28'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'args' --loc 'env\env.mbt:17:8'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'get_cli_args_internal' --loc 'env\env.mbt:18:3'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'get_cli_args_internal' --loc 'env\env_js.mbt:16:16'
Error: could not find definition for symbol 'get_cli_args_internal' at env\env_js.mbt:16:16
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'now_internal' --loc 'env\env_js.mbt:26:16'
Error: could not find definition for symbol 'now_internal' at env\env_js.mbt:26:16
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'args' --loc 'env\env_test.mbt:17:7'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'args' --loc 'env\env_test.mbt:17:19'
Definition found at file <WORKDIR>/env\env.mbt
   | // See the License for the specific language governing permissions and
   | // limitations under the License.
   | 
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'begin_create_string' --loc 'env\env_wasm.mbt:28:4'
Definition found at file <WORKDIR>/env\env_wasm.mbt
   | ///|
   | #external
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'XStringCreateHandle' --loc 'env\env_wasm.mbt:28:29'
Definition found at file <WORKDIR>/env\env_wasm.mbt
   | #external
