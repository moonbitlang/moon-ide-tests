...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'from_int' --loc 'builtin\int64.mbt:31:15'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'i' --loc 'builtin\int64.mbt:31:24'
Definition found at file <WORKDIR>/builtin\int64.mbt
   | /// ```mbt check
   | /// test {
   | ///   inspect(Int64::from_int(42), content="42")
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'ReprDelta' --loc 'debug\delta.mbt:17:11'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide peek-def 'Same' --loc 'debug\delta.mbt:18:3'
Definition found at file <WORKDIR>/debug\delta.mbt
   | // limitations under the License.
   | 
   | ///|
