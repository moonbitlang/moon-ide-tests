...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide find-references 'Reverse' --loc 'cmp\cmp.mbt:35:17'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide find-references 'T' --loc 'cmp\cmp.mbt:35:28'
Found 0 references for symbol 'T':
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide find-references 'args' --loc 'env\env.mbt:17:8'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide find-references 'get_cli_args_internal' --loc 'env\env.mbt:18:3'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide find-references 'get_cli_args_internal' --loc 'env\env_js.mbt:16:16'
Error: could not find references for symbol 'get_cli_args_internal' at env\env_js.mbt:16:16
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide find-references 'now_internal' --loc 'env\env_js.mbt:26:16'
Error: could not find references for symbol 'now_internal' at env\env_js.mbt:26:16
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide find-references 'args' --loc 'env\env_test.mbt:17:7'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide find-references 'args' --loc 'env\env_test.mbt:17:19'
Found 4 references for symbol 'args':
<WORKDIR>/argparse\parser.mbt:81:19-81:23:
   | 
   | ///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide find-references 'begin_create_string' --loc 'env\env_wasm.mbt:28:4'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\core' moon ide find-references 'XStringCreateHandle' --loc 'env\env_wasm.mbt:28:29'
