# json rename decode src\tests\json_value_semantics_test.mbt:3:22

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\json' moon ide rename 'decode' 'decode_renamed' --loc 'src\tests\json_value_semantics_test.mbt:3:22'
*** Begin Patch
