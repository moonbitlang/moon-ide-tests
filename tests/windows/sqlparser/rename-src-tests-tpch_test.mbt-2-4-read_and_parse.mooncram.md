# sqlparser rename read_and_parse src\tests\tpch_test.mbt:2:4

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide rename 'read_and_parse' 'read_and_parse_renamed' --loc 'src\tests\tpch_test.mbt:2:4'
*** Begin Patch
