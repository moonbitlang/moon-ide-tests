# sqlparser rename pass src\tests\good_test.mbt:4:4

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide rename 'pass' 'pass_renamed' --loc 'src\tests\good_test.mbt:4:4'
*** Begin Patch
