...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'BigQuery' --loc 'src\bigquery.mbt:3:17'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'BigQuery' --loc 'src\bigquery.mbt:6:22'
Definition found at file <WORKDIR>/src\bigquery.mbt
  | ///|
  | /// BigQuery dialect - supports Google BigQuery specific syntax
3 | pub(all) struct BigQuery {}
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'Parser' --loc 'src\dml.mbt:2:4'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'parse_set_expr' --loc 'src\dml.mbt:2:12'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'Generic' --loc 'src\generic.mbt:5:17'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'Generic' --loc 'src\generic.mbt:8:22'
Definition found at file <WORKDIR>/src\generic.mbt
  | ///|
  | /// Generic SQL dialect that supports the union of all other dialects
  | /// This is the most permissive dialect, useful for parsing various SQL statements
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'LexerError' --loc 'src\lexer.mbt:2:10'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'UnterminatedString' --loc 'src\lexer.mbt:3:3'
Definition found at file <WORKDIR>/src\lexer.mbt
  | ///|
  | suberror LexerError {
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'sql' --loc 'src\prepare.mbt:6:7'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'stmt' --loc 'src\prepare.mbt:7:7'
Definition found at file <WORKDIR>/src\prepare.mbt
  | /// Test cases for PREPARE/EXECUTE/DEALLOCATE statements
  | 
  | ///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'Redshift' --loc 'src\redshift.mbt:3:17'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'Redshift' --loc 'src\redshift.mbt:6:22'
Definition found at file <WORKDIR>/src\redshift.mbt
  | ///|
  | /// Redshift dialect - supports Amazon Redshift specific syntax
3 | pub(all) struct Redshift {}
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'show_compact_debug' --loc 'src\show.mbt:2:15'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide peek-def 'obj' --loc 'src\show.mbt:2:34'
Definition found at file <WORKDIR>/src\show.mbt
  | ///|
2 | fn[T : Debug] show_compact_debug(obj : T, logger : &Logger) -> Unit {
  |                                  ^^^
