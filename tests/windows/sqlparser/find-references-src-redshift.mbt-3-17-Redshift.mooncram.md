# sqlparser find-references Redshift src\redshift.mbt:3:17

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\sqlparser' moon ide find-references 'Redshift' --loc 'src\redshift.mbt:3:17'
