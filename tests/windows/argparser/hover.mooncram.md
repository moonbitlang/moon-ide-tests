...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\argparser' moon ide hover 'Trie' --loc 'arg.mbt:2:19'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\argparser' moon ide hover 'Spec' --loc 'arg.mbt:16:15'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\argparser' moon ide hover 'verbose' --loc 'arg_test.mbt:3:7'
///|
test {
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\argparser' moon ide hover 'keyword' --loc 'arg_test.mbt:4:7'
///|
test {
  let verbose : Ref[Bool] = Ref(true)
  let keyword : Ref[String] = Ref("")
