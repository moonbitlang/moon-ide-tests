...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\argparser' moon ide rename 'Trie' 'TrieRenamed' --loc 'arg.mbt:2:19'
*** Begin Patch
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\argparser' moon ide rename 'Spec' 'SpecRenamed' --loc 'arg.mbt:16:15'
*** Begin Patch
*** Update File: <WORKDIR>/arg.mbt
@@
...
-  let help_spec = Spec::Unit(() => raise ErrorMsg(help_msg))
+  let help_spec = SpecRenamed::Unit(() => raise ErrorMsg(help_msg))
   let trie = trie.add("--help", help_spec).add("-h", help_spec)
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\argparser' moon ide rename 'verbose' 'verbose_renamed' --loc 'arg_test.mbt:3:7'
*** Begin Patch
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\argparser' moon ide rename 'keyword' 'keyword_renamed' --loc 'arg_test.mbt:4:7'
*** Begin Patch
*** Update File: <WORKDIR>/arg_test.mbt
@@
 ///|
