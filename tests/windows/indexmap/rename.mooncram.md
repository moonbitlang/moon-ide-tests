...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\indexmap' moon ide rename 'Bucket' 'BucketRenamed' --loc 'src\types.mbt:17:13'
*** Begin Patch
*** Update File: <WORKDIR>/src\types.mbt
@@
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\indexmap' moon ide rename 'hash' 'hash_renamed' --loc 'src\types.mbt:18:3'
*** Begin Patch
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\indexmap' moon ide rename 'T' 'TRenamed' --loc 'src\IndexMap_test.mbt:17:19'
*** Begin Patch
*** Update File: <WORKDIR>/src\IndexMap.mbt
@@
 /// let map : @IndexMap.T[String, Int] = @IndexMap.new(capacity=16)
