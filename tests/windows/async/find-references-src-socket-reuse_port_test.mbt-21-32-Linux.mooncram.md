...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide find-references 'Linux' --loc 'src\socket\reuse_port_test.mbt:21:32'
Found 15 references for symbol 'Linux':
...
<WORKDIR>/src\socket\tcp.mbt:104:30-104:35:
