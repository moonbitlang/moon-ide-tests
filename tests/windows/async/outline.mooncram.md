...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide outline 'src\fs\dir.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide outline 'src\fs\file.mbt'
 16 |struct File {
    |...
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide outline 'src\fs\utils.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide outline 'src\fs\watch.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide outline 'src\fs\tmpdir.mbt'
