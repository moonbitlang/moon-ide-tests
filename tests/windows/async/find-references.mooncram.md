...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide find-references 'mkdir' --loc 'src\fs\dir.mbt:24:14'
Found 28 references for symbol 'mkdir':
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide find-references 'path' --loc 'src\fs\dir.mbt:25:3'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide find-references 'File' --loc 'src\fs\file.mbt:16:8'
Found 36 references for symbol 'File':
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide find-references 'io' --loc 'src\fs\file.mbt:17:3'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide find-references 'kind' --loc 'src\fs\utils.mbt:19:14'
Found 7 references for symbol 'kind':
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide find-references 'path' --loc 'src\fs\utils.mbt:19:19'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide find-references 'FileIdentity' --loc 'src\fs\watch.mbt:16:25'
...
<WORKDIR>/src\fs\watch.mbt:72:14-72:26:
...
<WORKDIR>/src\fs\watch_windows.mbt:33:14-33:26:
   | fn WindowsWatcher::WindowsWatcher(
   |   watcher : Watcher,
   |   root : @event_loop.IoHandle,
33 |   root_id~ : FileIdentity,
   |              ^^^^^^^^^^^^
   |   debounce_timeout~ : Int,
   |   max_debounce_delay~ : Int,

<WORKDIR>/src\fs\watch_windows.mbt:179:21-179:33:
    |     let mut offset = 0
    |     while offset < n {
    |       let size = buf.event_size(offset)
179 |       let file_id : FileIdentity = if WindowsWatcher::has_ReadDirectoryChangesExW() {
    |                     ^^^^^^^^^^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide find-references 'WatchedFile' --loc 'src\fs\watch.mbt:19:13'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide find-references 'tmpdir_seed' --loc 'src\fs\tmpdir.mbt:16:5'
Found 2 references for symbol 'tmpdir_seed':
<WORKDIR>/src\fs\tmpdir.mbt:16:5-16:16:
   | // limitations under the License.
   | 
   | ///|
...
<WORKDIR>/src\fs\tmpdir.mbt:56:27-56:38:
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide find-references 'Rand' --loc 'src\fs\tmpdir.mbt:16:22'
Found 7 references for symbol 'Rand':
<WORKDIR>/examples\tcp_server_benchmark\main.mbt:20:18-20:22:
   | 
   | ///|
   | async fn client(
20 |   rand : @random.Rand,
...
<WORKDIR>/examples\tcp_server_benchmark\main.mbt:119:13-119:17:
    |     ..write_uint64_le(now)
    |     ..write_uint64_le(now)
    |     .write_uint64_le(now)
...
<WORKDIR>/src\fs\tmpdir.mbt:16:27-16:31:
   | // limitations under the License.
   | 
   | ///|
16 | let tmpdir_seed : @random.Rand = {
...
<WORKDIR>/src\fs\tmpdir.mbt:22:11-22:15:
   |   for _ in 0..<4 {
