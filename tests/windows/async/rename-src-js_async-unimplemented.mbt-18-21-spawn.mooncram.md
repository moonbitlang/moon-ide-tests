...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\async' moon ide rename 'spawn' 'spawn_renamed' --loc 'src\js_async\unimplemented.mbt:18:21'
*** Begin Patch
...
*** Update File: <WORKDIR>/src\internal\event_loop\network.mbt
@@
