...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'doc\005_http\using_test.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'doc\001_intro\using_test.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'doc\003_router\using_test.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'doc\002_writing_html\using_test.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'doc\004_using_command\using_test.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'doc\using_subscriptions\using_test.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'doc\suberror_as_extensible_enum\using_test.mbt'
2 |test {
  |...
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'utils\shiki\shiki.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\log\log.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\vfs\vfs.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\path\artifact_path.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\path\mooncakeio_path.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\devhub\devhub.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\devtool\main.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\log.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\main.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\build.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\templates\default\main\main.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\utils.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\new_project.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\templates_bundle.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'rabbita\js\cast.mbt'
  6 |#cfg(target="js")
