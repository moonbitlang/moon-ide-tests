...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'rabbita\clipboard\aliases.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'rabbita\clipboard\clipboard.mbt'
 2 |pub(all) enum Item {
   |...
13 |#cfg(target="js")
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'rabbita\dom\clipboard_event.mbt'
 2 |#cfg(target="js")
 3 |#external
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'rabbita\dom\gpu_canvas_context.mbt'
2 |#cfg(target="js")
3 |#external
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'rabbita\dom\image_data.mbt'
 2 |#cfg(target="js")
 3 |#external
 4 |type ImageData
   |...
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'rabbita\dom\webgl_rendering_context.mbt'
2 |#cfg(target="js")
3 |#external
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'rabbita\internal\runtime\sandbox.mbt'
  2 |#cfg(target="js")
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\embbed_devtool.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\path\sourcetree_path.mbt'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide outline 'warren\templates\minimized\main.mbt'
