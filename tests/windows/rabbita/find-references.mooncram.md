...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Cell' --loc 'doc\005_http\using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc\005_http\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Emit' --loc 'doc\005_http\using_test.mbt:2:33'
Error: could not get package of file <WORKDIR>/doc\005_http\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Cell' --loc 'doc\001_intro\using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc\001_intro\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'div' --loc 'doc\001_intro\using_test.mbt:5:14'
Error: could not get package of file <WORKDIR>/doc\001_intro\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Emit' --loc 'doc\003_router\using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc\003_router\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Cmd' --loc 'doc\003_router\using_test.mbt:2:33'
Error: could not get package of file <WORKDIR>/doc\003_router\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Emit' --loc 'doc\002_writing_html\using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc\002_writing_html\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Html' --loc 'doc\002_writing_html\using_test.mbt:2:33'
Error: could not get package of file <WORKDIR>/doc\002_writing_html\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Emit' --loc 'doc\004_using_command\using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc\004_using_command\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Cmd' --loc 'doc\004_using_command\using_test.mbt:2:33'
Error: could not get package of file <WORKDIR>/doc\004_using_command\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Emit' --loc 'doc\using_subscriptions\using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc\using_subscriptions\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Cell' --loc 'doc\using_subscriptions\using_test.mbt:2:33'
Error: could not get package of file <WORKDIR>/doc\using_subscriptions\using_test.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'load_shiki' --loc 'utils\shiki\shiki.mbt:2:16'
Error: could not get package of file <WORKDIR>/utils\shiki\shiki.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Promise' --loc 'utils\shiki\shiki.mbt:2:28'
Error: could not get package of file <WORKDIR>/utils\shiki\shiki.mbt
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'log' --loc 'warren\log\log.mbt:2:8'
Found 5 references for symbol 'log':
<WORKDIR>/warren\devhub\devhub.mbt:121:12-121:15:
    | 
...
<WORKDIR>/warren\devhub\devhub.mbt:128:10-128:13:
    |       panic()
    |     }
    | 
128 |     @log.log(
...
<WORKDIR>/warren\devhub\devhub.mbt:133:12-133:15:
    |       "Port \{port} is occupied by previous warren process \{pid}. Killing it...",
    |     )
...
<WORKDIR>/warren\log.mbt:3:8-3:11:
  | ///|
...
<WORKDIR>/warren\log\log.mbt:2:8-2:11:
  | ///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'tag' --loc 'warren\log\log.mbt:2:12'
Found 7 references for symbol 'tag':
<WORKDIR>/warren\log\log.mbt:2:12-2:15:
  | ///|
2 | pub fn log(tag : String, msg : String) -> Unit {
  |            ^^^
  |   let display_tag = if tag.length() < 7 {
...
<WORKDIR>/warren\log\log.mbt:3:24-3:27:
  | ///|
  | pub fn log(tag : String, msg : String) -> Unit {
3 |   let display_tag = if tag.length() < 7 {
  |                        ^^^
  |     let prefix = " ".repeat(7 - tag.length())
  |     "\{prefix}[\{tag}]"

<WORKDIR>/warren\log\log.mbt:4:33-4:36:
  | ///|
  | pub fn log(tag : String, msg : String) -> Unit {
  |   let display_tag = if tag.length() < 7 {
4 |     let prefix = " ".repeat(7 - tag.length())
  |                                 ^^^
  |     "\{prefix}[\{tag}]"
  |   } else {

<WORKDIR>/warren\log\log.mbt:5:18-5:21:
  | pub fn log(tag : String, msg : String) -> Unit {
  |   let display_tag = if tag.length() < 7 {
  |     let prefix = " ".repeat(7 - tag.length())
5 |     "\{prefix}[\{tag}]"
...
<WORKDIR>/warren\log\log.mbt:7:9-7:12:
  |     let prefix = " ".repeat(7 - tag.length())
  |     "\{prefix}[\{tag}]"
  |   } else {
7 |     "[\{tag}]"
...
<WORKDIR>/warren\log\log.mbt:23:25-23:28:
   |       }
   |   }
   | 
23 |   let tag_color = match tag {
   |                         ^^^
   |     "error" | "err" | "fatal" => "\u001b[31m"
   |     "info" => "\u001b[37m"

<WORKDIR>/warren\log\log.mbt:40:26-40:29:
   |   let time = "\{hh}:\{mm}"
   |   if use_color {
   |     let reset = "\u001b[0m"
40 |     let display_msg = if tag == "info" {
   |                          ^^^
   |       "\u001b[37m\{msg}\{reset}"
   |     } else {
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'SourcePath' --loc 'warren\vfs\vfs.mbt:2:19'
Found 3 references for symbol 'SourcePath':
...
<WORKDIR>/warren\vfs\vfs.mbt:6:20-6:30:
  | 
  | ///|
  | pub(all) enum VirtualFs {
6 |   DirectoryMapping(SourcePath)
  |                    ^^^^^^^^^^
  |   FileMapping(SourcePath)
  |   DirectoryContent(Map[String, VirtualFs])

<WORKDIR>/warren\vfs\vfs.mbt:7:15-7:25:
  | ///|
  | pub(all) enum VirtualFs {
  |   DirectoryMapping(SourcePath)
7 |   FileMapping(SourcePath)
  |               ^^^^^^^^^^
  |   DirectoryContent(Map[String, VirtualFs])
  |   FileContent(String)
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'VirtualFs' --loc 'warren\vfs\vfs.mbt:5:15'
Found 6 references for symbol 'VirtualFs':
<WORKDIR>/warren\vfs\vfs.mbt:5:15-5:24:
...
<WORKDIR>/warren\vfs\vfs.mbt:8:32-8:41:
  | pub(all) enum VirtualFs {
  |   DirectoryMapping(SourcePath)
  |   FileMapping(SourcePath)
8 |   DirectoryContent(Map[String, VirtualFs])
  |                                ^^^^^^^^^
  |   FileContent(String)
  | } derive(Debug)

<WORKDIR>/warren\vfs\vfs.mbt:14:23-14:32:
   | 
   | ///|
   | struct VirtualFileSystem {
14 |   roots : Map[String, VirtualFs]
   |                       ^^^^^^^^^
   | } derive(Debug)
   | 

<WORKDIR>/warren\vfs\vfs.mbt:19:49-19:58:
   | 
   | ///|
   | #as_free_fn
...
<WORKDIR>/warren\vfs\vfs.mbt:32:9-32:18:
...
<WORKDIR>/warren\vfs\vfs.mbt:76:35-76:44:
   |     return
   |   }
   | 
76 |   fn remove(entries : Map[String, VirtualFs], i : Int) -> Unit {
   |                                   ^^^^^^^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'ArtifactPath' --loc 'warren\path\artifact_path.mbt:2:8'
Found 9 references for symbol 'ArtifactPath':
<WORKDIR>/warren\path\artifact_path.mbt:2:8-2:20:
  | ///|
...
<WORKDIR>/warren\path\artifact_path.mbt:29:20-29:32:
...
<WORKDIR>/warren\path\artifact_path.mbt:34:8-34:20:
   | }
   | 
   | ///|
...
<WORKDIR>/warren\path\artifact_path.mbt:37:6-37:18:
...
<WORKDIR>/warren\path\artifact_path.mbt:42:8-42:20:
   | }
   | 
   | ///|
...
<WORKDIR>/warren\path\artifact_path.mbt:42:48-42:60:
   | }
   | 
   | ///|
42 | pub fn ArtifactPath::new(root : SourcePath) -> ArtifactPath {
...
<WORKDIR>/warren\path\artifact_path.mbt:47:8-47:20:
   | }
   | 
   | ///|
...
<WORKDIR>/warren\path\artifact_path.mbt:47:63-47:75:
   | }
   | 
   | ///|
47 | pub fn ArtifactPath::join_relative(s1 : Self, s2 : String) -> ArtifactPath {
...
<WORKDIR>/warren\path\artifact_path.mbt:52:8-52:20:
   | }
   | 
   | ///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'root' --loc 'warren\path\artifact_path.mbt:3:3'
Found 3 references for symbol 'root':
<WORKDIR>/warren\path\artifact_path.mbt:3:3-3:7:
  | ///|
  | struct ArtifactPath {
3 |   root : SourcePath
  |   ^^^^
...
<WORKDIR>/warren\path\artifact_path.mbt:43:5-43:9:
   | 
   | ///|
   | pub fn ArtifactPath::new(root : SourcePath) -> ArtifactPath {
43 |   { root, relative: "", mod_path: None }
   |     ^^^^
   | }
   | 

<WORKDIR>/warren\path\artifact_path.mbt:58:22-58:26:
   |   build : Build,
   |   mode : Mode,
   | ) -> SourcePath {
58 |   let mut acc = self.root
   |                      ^^^^
   |   acc = acc.join(
   |     match target {
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'MooncakesPath' --loc 'warren\path\mooncakeio_path.mbt:2:8'
Found 8 references for symbol 'MooncakesPath':
<WORKDIR>/warren\path\artifact_path.mbt:36:9-36:22:
   | ///|
   | pub fn ArtifactPath::join_module_path(
   |   self : Self,
...
<WORKDIR>/warren\path\mooncakeio_path.mbt:2:8-2:21:
  | ///|
...
<WORKDIR>/warren\path\mooncakeio_path.mbt:5:8-5:21:
...
<WORKDIR>/warren\path\mooncakeio_path.mbt:6:3-6:16:
  | 
  | ///|
...
<WORKDIR>/warren\path\mooncakeio_path.mbt:10:8-10:21:
   | }
   | 
   | ///|
...
<WORKDIR>/warren\path\mooncakeio_path.mbt:15:8-15:21:
   | }
   | 
   | ///|
...
<WORKDIR>/warren\path\mooncakeio_path.mbt:20:20-20:33:
   | }
   | 
   | ///|
...
<WORKDIR>/warren\path\mooncakeio_path.mbt:25:19-25:32:
   | }
   | 
   | ///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'MooncakesPath' --loc 'warren\path\mooncakeio_path.mbt:5:8'
Found 8 references for symbol 'MooncakesPath':
<WORKDIR>/warren\path\artifact_path.mbt:36:9-36:22:
   | ///|
   | pub fn ArtifactPath::join_module_path(
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Path' --loc 'warren\path\sourcetree_path.mbt:2:15'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'BroadcastMsg' --loc 'warren\devhub\devhub.mbt:2:15'
Found 4 references for symbol 'BroadcastMsg':
<WORKDIR>/warren\devhub\devhub.mbt:2:15-2:27:
  | ///|
...
<WORKDIR>/warren\devhub\devhub.mbt:19:44-19:56:
   |   priv vfs : @vfs.VirtualFileSystem
   |   priv client_msgs : @async.Queue[ClientMsg]
   |   priv mut next_id : Int
19 |   priv subscribers : Map[Int, @async.Queue[BroadcastMsg]]
   |                                            ^^^^^^^^^^^^
   | }
   | 

<WORKDIR>/warren\devhub\devhub.mbt:169:45-169:57:
    | }
    | 
    | ///|
...
<WORKDIR>/warren\main.mbt:5:21-5:33:
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Building' --loc 'warren\devhub\devhub.mbt:3:3'
Found 3 references for symbol 'Building':
<WORKDIR>/warren\devhub\devhub.mbt:3:3-3:11:
  | ///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Cmd' --loc 'warren\devtool\main.mbt:2:22'
Found 2 references for symbol 'Cmd':
<WORKDIR>/warren\devtool\main.mbt:2:22-2:25:
  | ///|
...
<WORKDIR>/warren\devtool\main.mbt:187:59-187:62:
    | }
    | 
    | ///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Emit' --loc 'warren\devtool\main.mbt:2:32'
Found 5 references for symbol 'Emit':
<WORKDIR>/warren\devtool\main.mbt:2:32-2:36:
  | ///|
2 | using @rabbita {type Cmd, type Emit, type Html, delay, new, none}
  |                                ^^^^
  | 
...
<WORKDIR>/warren\devtool\main.mbt:187:18-187:22:
    | }
    | 
    | ///|
187 | fn update(emit : Emit[Msg], msg : Msg, model : Model) -> (Cmd, Model) {
...
<WORKDIR>/warren\devtool\main.mbt:277:25-277:29:
    | }
    | 
    | ///|
...
<WORKDIR>/warren\devtool\main.mbt:307:22-307:26:
    | }
    | 
    | ///|
...
<WORKDIR>/warren\devtool\main.mbt:344:16-344:20:
    | }
    | 
    | ///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'log' --loc 'warren\log.mbt:2:4'
Found 17 references for symbol 'log':
<WORKDIR>/warren\build.mbt:107:3-107:6:
    |     source_path_to_string(target_dir),
    |   ]
    |   let command = args.join(" ")
107 |   log("build", "Running `moon \{command}`")
    |   ^^^
    |   let exit_code = @process.run("moon", args) catch {
    |     err => abort("Failed to run `moon build`: \{err}")

<WORKDIR>/warren\build.mbt:133:3-133:6:
    |   cwd : SourcePath,
    |   label : String,
    | ) -> Bool {
133 |   log("build", "Minifying JS with \{label}")
    |   ^^^
    |   try @process.run(cmd, args, cwd=source_path_to_string(cwd)) catch {
    |     err => {

<WORKDIR>/warren\build.mbt:136:7-136:10:
    |   log("build", "Minifying JS with \{label}")
    |   try @process.run(cmd, args, cwd=source_path_to_string(cwd)) catch {
    |     err => {
136 |       log("warn", "\{label} failed: \{err}. Falling back to release JS")
    |       ^^^
    |       false
    |     }

<WORKDIR>/warren\build.mbt:142:7-142:10:
    |   } noraise {
    |     0 => true
    |     code => {
142 |       log(
...
<WORKDIR>/warren\build.mbt:209:3-209:6:
    |     return
    |   }
    | 
209 |   log(
...
<WORKDIR>/warren\build.mbt:256:3-256:6:
    |   minify_or_copy_js(release_js, dist_dir.join("index.js"), mod_root)
    |   write_index_html(dist_dir)
    | 
256 |   log("build", "Build output written to \{dist_dir}")
    |   ^^^
    | }
    | 

<WORKDIR>/warren\log.mbt:2:4-2:7:
  | ///|
...
<WORKDIR>/warren\log.mbt:8:3-8:6:
  | 
  | ///|
...
<WORKDIR>/warren\main.mbt:194:7-194:10:
    |   match tag {
    |     Some(p) => (html[:p] + patch + html[p:]).to_owned()
    |     None => {
194 |       log("warn", "No </head> or </html> tag in index.html")
    |       ^^^
    |       if html.has_suffix("\n") {
    |         html + patch

<WORKDIR>/warren\main.mbt:309:5-309:8:
    |   @async.with_task_group <| group => {
    |     let hub = Devhub(port, vfs)
    |     group.spawn_bg(no_wait=true, allow_failure=true, () => hub.run_forever())
309 |     log("info", "Running server on http://127.0.0.1:\{hub.port()}")
    |     ^^^
    | 
    |     while true {

<WORKDIR>/warren\main.mbt:317:7-317:10:
    |       close_stdin.close()
    |       @fs.rmdir(target_dir, recursive=true)
    |       hub.broadcast(BroadcastMsg::Building)
317 |       log("warren", "Building...")
    |       ^^^
    | 
    |       defer reader.close()

<WORKDIR>/warren\main.mbt:338:13-338:16:
    |           if line != "" {
...
<WORKDIR>/warren\main.mbt:345:9-345:12:
    |       }
    | 
    |       if code == 0 {
345 |         log("warren", "moon build succeed at \{main_pkg_dir}.")
    |         ^^^
    |         let js_paths = find_js_in(
    |           Path::join(target_dir, "js/debug/build").to_string(),

<WORKDIR>/warren\main.mbt:350:11-350:14:
    |           Path::join(target_dir, "js/debug/build").to_string(),
    |         )
    |         guard js_paths is [js_path] else {
350 |           log("error", "found multiple entries: \{to_repr(js_paths)}")
    |           ^^^
    |           log(
    |             "info", "Use `warren dev path/to/main/package/dir` to choose one entry.",

<WORKDIR>/warren\main.mbt:351:11-351:14:
    |         )
    |         guard js_paths is [js_path] else {
...
<WORKDIR>/warren\main.mbt:370:9-370:12:
    |         vfs.mount("index.js", FileMapping(SourcePath::new(js_path)))
    |         // debug(vfs)
    |         hub.broadcast(BroadcastMsg::Reload)
370 |         log("warren", "Changes detected. Reloading...")
    |         ^^^
    |       } else {
    |         hub.broadcast(

<WORKDIR>/warren\main.mbt:377:9-377:12:
    |             build_failure_diagnostics(diagnostics.to_string(), code),
    |           ),
    |         )
377 |         log("error", "moon exited with code \{code}.")
    |         ^^^
    |       }
    | 
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'tag' --loc 'warren\log.mbt:2:8'
Found 2 references for symbol 'tag':
<WORKDIR>/warren\log.mbt:2:8-2:11:
  | ///|
2 | fn log(tag : String, msg : String) -> Unit {
  |        ^^^
  |   @log.log(tag, msg)
...
<WORKDIR>/warren\log.mbt:3:12-3:15:
  | ///|
  | fn log(tag : String, msg : String) -> Unit {
3 |   @log.log(tag, msg)
  |            ^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'SourcePath' --loc 'warren\main.mbt:2:19'
Found 24 references for symbol 'SourcePath':
<WORKDIR>/warren\build.mbt:6:33-6:43:
...
<WORKDIR>/warren\build.mbt:68:34-68:44:
   | }
   | 
   | ///|
...
<WORKDIR>/warren\build.mbt:86:34-86:44:
   | }
   | 
   | ///|
...
<WORKDIR>/warren\build.mbt:86:52-86:62:
   | }
   | 
   | ///|
86 | async fn copy_dir_contents(src : SourcePath, dst : SourcePath) -> Unit {
...
<WORKDIR>/warren\build.mbt:94:18-94:28:
   | 
   | ///|
...
<WORKDIR>/warren\build.mbt:95:16-95:26:
   | ///|
   | async fn run_release_build(
...
<WORKDIR>/warren\build.mbt:130:9-130:19:
...
<WORKDIR>/warren\build.mbt:152:38-152:48:
    | }
    | 
    | ///|
...
<WORKDIR>/warren\build.mbt:178:9-178:19:
    | 
    | ///|
...
<WORKDIR>/warren\build.mbt:179:9-179:19:
    | ///|
    | async fn minify_or_copy_js(
    |   src : SourcePath,
179 |   dst : SourcePath,
...
<WORKDIR>/warren\build.mbt:180:14-180:24:
    | async fn minify_or_copy_js(
    |   src : SourcePath,
    |   dst : SourcePath,
...
<WORKDIR>/warren\build.mbt:217:18-217:28:
    | 
    | ///|
...
<WORKDIR>/warren\build.mbt:218:15-218:25:
    | ///|
    | pub async fn build_project(
    |   main_pkg_dir : SourcePath,
...
<WORKDIR>/warren\build.mbt:222:5-222:15:
    | ) -> Unit {
    |   let main_pkg_dir_str = source_path_to_string(main_pkg_dir)
    |   let mod_root = if Path::basename(main_pkg_dir_str) == "main" {
222 |     SourcePath::new(Path::dirname(main_pkg_dir_str).to_string())
    |     ^^^^^^^^^^
    |   } else {
    |     main_pkg_dir

<WORKDIR>/warren\build.mbt:226:20-226:30:
    |   } else {
    |     main_pkg_dir
    |   }
226 |   let target_dir = SourcePath::new(@fs.tmpdir(prefix="warren"))
    |                    ^^^^^^^^^^
    |   let dist_dir = dist_dir.unwrap_or(mod_root.join("dist"))
    |   let public_dir = mod_root.join("public")

<WORKDIR>/warren\build.mbt:237:18-237:28:
    |   ).to_string()
    |   let js_paths = find_js_in(build_dir)
    |   let release_js = match js_paths {
237 |     [js_path] => SourcePath::new(js_path)
    |                  ^^^^^^^^^^
...
<WORKDIR>/warren\main.mbt:163:9-163:19:
    |         _ => Path::join(cwd, "dist").to_string()
    |       }
    |       build_project(
163 |         SourcePath::new(main_pkg_dir),
    |         ^^^^^^^^^^
    |         dist_dir=SourcePath::new(dist_dir),
    |       )

<WORKDIR>/warren\main.mbt:164:18-164:28:
    |       }
    |       build_project(
    |         SourcePath::new(main_pkg_dir),
164 |         dist_dir=SourcePath::new(dist_dir),
    |                  ^^^^^^^^^^
    |       )
    |     }

<WORKDIR>/warren\main.mbt:282:37-282:47:
    | 
    |   let vfs = @vfs.new({})
    |   if public_dir is Some(dir) {
282 |     vfs.mount("/", DirectoryMapping(SourcePath::new(dir)))
    |                                     ^^^^^^^^^^
    |     let files = @fs.readdir(dir)
    |     if files.contains("index.html") {

<WORKDIR>/warren\main.mbt:362:49-362:59:
    |           .to_string()
    | 
    |         if @fs.exists(js_map_path) {
362 |           vfs.mount("index.js.map", FileMapping(SourcePath::new(js_map_path)))
    |                                                 ^^^^^^^^^^
    |         } else {
    |           vfs.unmount("index.js.map")

<WORKDIR>/warren\main.mbt:367:43-367:53:
    |           vfs.unmount("index.js.map")
    |         }
    | 
367 |         vfs.mount("index.js", FileMapping(SourcePath::new(js_path)))
    |                                           ^^^^^^^^^^
    |         // debug(vfs)
    |         hub.broadcast(BroadcastMsg::Reload)

<WORKDIR>/warren\utils.mbt:2:26-2:36:
  | ///|
...
<WORKDIR>/warren\utils.mbt:2:45-2:55:
  | ///|
2 | pub async fn copy(src~ : SourcePath, dst~ : SourcePath) -> Unit {
  |                                             ^^^^^^^^^^
  |   let src_str = "\{src}"
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Path' --loc 'warren\main.mbt:2:36'
Found 23 references for symbol 'Path':
<WORKDIR>/warren\build.mbt:221:21-221:25:
    |   dist_dir? : SourcePath,
    | ) -> Unit {
    |   let main_pkg_dir_str = source_path_to_string(main_pkg_dir)
221 |   let mod_root = if Path::basename(main_pkg_dir_str) == "main" {
    |                     ^^^^
    |     SourcePath::new(Path::dirname(main_pkg_dir_str).to_string())
    |   } else {

<WORKDIR>/warren\build.mbt:222:21-222:25:
    | ) -> Unit {
    |   let main_pkg_dir_str = source_path_to_string(main_pkg_dir)
    |   let mod_root = if Path::basename(main_pkg_dir_str) == "main" {
222 |     SourcePath::new(Path::dirname(main_pkg_dir_str).to_string())
...
<WORKDIR>/warren\build.mbt:231:19-231:23:
    |   let public_dir = mod_root.join("public")
    | 
    |   run_release_build(main_pkg_dir, target_dir)
231 |   let build_dir = Path::join(
    |                   ^^^^
    |     source_path_to_string(target_dir),
    |     "js/release/build",
...
<WORKDIR>/warren\main.mbt:117:22-117:26:
    |   guard cli.subcommand is Some((subcmd, submatches)) else { return }
    |   match subcmd {
    |     "dev" => {
117 |       let cwd_main = Path::join(cwd, "main").to_string()
    |                      ^^^^
    |       let main_pkg_dir = match submatches.values.get("main-package-dir") {
    |         Some([path]) => Path::resolve(path).to_string()

<WORKDIR>/warren\main.mbt:119:25-119:29:
    |     "dev" => {
    |       let cwd_main = Path::join(cwd, "main").to_string()
    |       let main_pkg_dir = match submatches.values.get("main-package-dir") {
119 |         Some([path]) => Path::resolve(path).to_string()
    |                         ^^^^
    |         _ if @fs.exists(cwd_main) => cwd_main
    |         _ => cwd

<WORKDIR>/warren\main.mbt:123:24-123:28:
    |         _ if @fs.exists(cwd_main) => cwd_main
    |         _ => cwd
    |       }
123 |       let cwd_public = Path::join(cwd, "public").to_string()
    |                        ^^^^
    |       let public_dir = match submatches.values.get("public-dir") {
    |         Some([path]) => Some(Path::resolve(path).to_string())

<WORKDIR>/warren\main.mbt:125:30-125:34:
    |       }
    |       let cwd_public = Path::join(cwd, "public").to_string()
    |       let public_dir = match submatches.values.get("public-dir") {
125 |         Some([path]) => Some(Path::resolve(path).to_string())
    |                              ^^^^
    |         _ if @fs.exists(cwd_public) => Some(cwd_public)
    |         _ => None

<WORKDIR>/warren\main.mbt:152:22-152:26:
    |       dev_server(main_pkg_dir~, target_dir~, public_dir~, port~)
    |     }
    |     "build" => {
152 |       let cwd_main = Path::join(cwd, "main").to_string()
    |                      ^^^^
    |       let main_pkg_dir = match submatches.values.get("main-package-dir") {
    |         Some([path]) => Path::resolve(path).to_string()

<WORKDIR>/warren\main.mbt:154:25-154:29:
    |     "build" => {
    |       let cwd_main = Path::join(cwd, "main").to_string()
    |       let main_pkg_dir = match submatches.values.get("main-package-dir") {
154 |         Some([path]) => Path::resolve(path).to_string()
    |                         ^^^^
    |         _ if @fs.exists(cwd_main) => cwd_main
    |         _ => cwd

<WORKDIR>/warren\main.mbt:159:25-159:29:
    |         _ => cwd
    |       }
    |       let dist_dir = match submatches.values.get("dist") {
159 |         Some([path]) => Path::resolve(path).to_string()
    |                         ^^^^
    |         _ => Path::join(cwd, "dist").to_string()
    |       }

<WORKDIR>/warren\main.mbt:160:14-160:18:
    |       }
    |       let dist_dir = match submatches.values.get("dist") {
    |         Some([path]) => Path::resolve(path).to_string()
160 |         _ => Path::join(cwd, "dist").to_string()
    |              ^^^^
    |       }
    |       build_project(

<WORKDIR>/warren\main.mbt:285:32-285:36:
    |     vfs.mount("/", DirectoryMapping(SourcePath::new(dir)))
    |     let files = @fs.readdir(dir)
    |     if files.contains("index.html") {
285 |       let html = @fs.read_file(Path::join(dir, "index.html").to_string()).text()
    |                                ^^^^
    |       vfs.mount(
    |         "/__warren/preview/index.html",

<WORKDIR>/warren\main.mbt:347:11-347:15:
    |       if code == 0 {
    |         log("warren", "moon build succeed at \{main_pkg_dir}.")
    |         let js_paths = find_js_in(
347 |           Path::join(target_dir, "js/debug/build").to_string(),
    |           ^^^^
    |         )
    |         guard js_paths is [js_path] else {

<WORKDIR>/warren\main.mbt:356:24-356:28:
    |           )
    |         }
    | 
356 |         let basename = Path::basename(js_path)
    |                        ^^^^
    |         let js_map_path = Path::dirname(js_path)
    |           .join("\{basename}.map")

<WORKDIR>/warren\main.mbt:357:27-357:31:
    |         }
    | 
    |         let basename = Path::basename(js_path)
357 |         let js_map_path = Path::dirname(js_path)
    |                           ^^^^
    |           .join("\{basename}.map")
    |           .to_string()

<WORKDIR>/warren\main.mbt:392:18-392:22:
    |     let handle = @fs.opendir(dir)
    |     defer handle.close()
    |     while handle.next() is Some(entry) {
392 |       let path = Path::join(dir, entry.name).to_string()
    |                  ^^^^
    |       if entry.is_dir {
    |         collect_js_in(path, js_paths)

<WORKDIR>/warren\new_project.mbt:57:14-57:18:
   |   relative_path : String,
   |   content : String,
   | ) -> Unit {
57 |   let path = Path::join(root, relative_path).to_string()
   |              ^^^^
   |   let parent = Path::dirname(path).to_string()
   |   if parent != "" && parent != "." && !@fs.exists(parent) {

<WORKDIR>/warren\new_project.mbt:58:16-58:20:
   |   content : String,
   | ) -> Unit {
   |   let path = Path::join(root, relative_path).to_string()
58 |   let parent = Path::dirname(path).to_string()
   |                ^^^^
   |   if parent != "" && parent != "." && !@fs.exists(parent) {
   |     @fs.mkdir(parent, permission=0o755, recursive=true)

<WORKDIR>/warren\new_project.mbt:77:9-77:13:
   |       let path = if parent == "" {
   |         name
   |       } else {
77 |         Path::join(parent, name).to_string()
   |         ^^^^
   |       }
   |       write_new_project_file(

<WORKDIR>/warren\new_project.mbt:91:9-91:13:
   |       } else if parent == "" {
   |         name
   |       } else {
91 |         Path::join(parent, name).to_string()
   |         ^^^^
   |       }
   |       for child in children {

<WORKDIR>/warren\new_project.mbt:102:20-102:24:
    | 
    | ///|
    | async fn new_project(dir : String, template_name : String) -> Unit {
102 |   let target_dir = Path::resolve(dir).to_string()
    |                    ^^^^
    |   let project_name = Path::basename(target_dir).to_owned()
    |   let template_dir = match template_name {

<WORKDIR>/warren\new_project.mbt:103:22-103:26:
    | ///|
    | async fn new_project(dir : String, template_name : String) -> Unit {
    |   let target_dir = Path::resolve(dir).to_string()
103 |   let project_name = Path::basename(target_dir).to_owned()
    |                      ^^^^
    |   let template_dir = match template_name {
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'build_entry_script' --loc 'warren\build.mbt:2:5'
Found 3 references for symbol 'build_entry_script':
<WORKDIR>/warren\build.mbt:2:5-2:23:
  | ///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'source_path_to_string' --loc 'warren\build.mbt:6:4'
Found 14 references for symbol 'source_path_to_string':
<WORKDIR>/warren\build.mbt:6:4-6:25:
  |   #|    <script src="./index.js" type="module"></script>
  | 
  | ///|
6 | fn source_path_to_string(path : SourcePath) -> String {
...
<WORKDIR>/warren\build.mbt:69:18-69:39:
   | 
   | ///|
   | async fn ensure_clean_dir(path : SourcePath) -> Unit {
69 |   let path_str = source_path_to_string(path)
   |                  ^^^^^^^^^^^^^^^^^^^^^
   |   if @fs.exists(path_str) {
   |     match @fs.kind(path_str) {

<WORKDIR>/warren\build.mbt:87:28-87:49:
   | 
   | ///|
   | async fn copy_dir_contents(src : SourcePath, dst : SourcePath) -> Unit {
87 |   for entry in @fs.readdir(source_path_to_string(src), sort=true) {
   |                            ^^^^^^^^^^^^^^^^^^^^^
   |     copy(src=src.join(entry), dst=dst.join(entry))
   |   }

<WORKDIR>/warren\build.mbt:99:5-99:26:
   | ) -> Unit {
   |   let args = [
   |     "build",
99 |     source_path_to_string(main_pkg_dir),
   |     ^^^^^^^^^^^^^^^^^^^^^
   |     "--target",
   |     "js",

<WORKDIR>/warren\build.mbt:104:5-104:26:
    |     "js",
    |     "--release",
    |     "--target-dir",
104 |     source_path_to_string(target_dir),
    |     ^^^^^^^^^^^^^^^^^^^^^
    |   ]
    |   let command = args.join(" ")

<WORKDIR>/warren\build.mbt:134:35-134:56:
    |   label : String,
    | ) -> Bool {
    |   log("build", "Minifying JS with \{label}")
134 |   try @process.run(cmd, args, cwd=source_path_to_string(cwd)) catch {
    |                                   ^^^^^^^^^^^^^^^^^^^^^
    |     err => {
    |       log("warn", "\{label} failed: \{err}. Falling back to release JS")

<WORKDIR>/warren\build.mbt:154:19-154:40:
    | ///|
    | async fn write_index_html(dist_dir : SourcePath) -> Unit {
    |   let index_path = dist_dir.join("index.html")
154 |   let index_str = source_path_to_string(index_path)
    |                   ^^^^^^^^^^^^^^^^^^^^^
    |   if @fs.exists(index_str) {
    |     let html = @fs.read_file(index_str).text()

<WORKDIR>/warren\build.mbt:165:7-165:28:
    |     )
    |   } else {
    |     let has_stylesheet = @fs.exists(
165 |       source_path_to_string(dist_dir.join("styles.css")),
    |       ^^^^^^^^^^^^^^^^^^^^^
    |     )
    |     @fs.write_file(

<WORKDIR>/warren\build.mbt:182:17-182:38:
    |   dst : SourcePath,
    |   mod_root : SourcePath,
    | ) -> Unit {
182 |   let src_str = source_path_to_string(src)
    |                 ^^^^^^^^^^^^^^^^^^^^^
    |   let dst_str = source_path_to_string(dst)
    |   let terser_args = [

<WORKDIR>/warren\build.mbt:183:17-183:38:
    |   mod_root : SourcePath,
    | ) -> Unit {
    |   let src_str = source_path_to_string(src)
183 |   let dst_str = source_path_to_string(dst)
    |                 ^^^^^^^^^^^^^^^^^^^^^
    |   let terser_args = [
    |     src_str, "-c", "toplevel=true", "-m", "toplevel=true", "-o", dst_str,

<WORKDIR>/warren\build.mbt:220:26-220:47:
    |   main_pkg_dir : SourcePath,
    |   dist_dir? : SourcePath,
    | ) -> Unit {
220 |   let main_pkg_dir_str = source_path_to_string(main_pkg_dir)
    |                          ^^^^^^^^^^^^^^^^^^^^^
    |   let mod_root = if Path::basename(main_pkg_dir_str) == "main" {
    |     SourcePath::new(Path::dirname(main_pkg_dir_str).to_string())

<WORKDIR>/warren\build.mbt:232:5-232:26:
    | 
    |   run_release_build(main_pkg_dir, target_dir)
    |   let build_dir = Path::join(
232 |     source_path_to_string(target_dir),
    |     ^^^^^^^^^^^^^^^^^^^^^
    |     "js/release/build",
    |   ).to_string()

<WORKDIR>/warren\build.mbt:246:17-246:38:
    |   }
    | 
    |   ensure_clean_dir(dist_dir)
246 |   if @fs.exists(source_path_to_string(public_dir)) {
    |                 ^^^^^^^^^^^^^^^^^^^^^
    |     guard @fs.kind(source_path_to_string(public_dir)) is Directory else {
    |       abort("`public` exists but is not a directory: \{public_dir}")

<WORKDIR>/warren\build.mbt:247:20-247:41:
    | 
    |   ensure_clean_dir(dist_dir)
    |   if @fs.exists(source_path_to_string(public_dir)) {
247 |     guard @fs.kind(source_path_to_string(public_dir)) is Directory else {
    |                    ^^^^^^^^^^^^^^^^^^^^^
    |       abort("`public` exists but is not a directory: \{public_dir}")
    |     }
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'a' --loc 'warren\templates\default\main\main.mbt:2:14'
Found 2 references for symbol 'a':
<WORKDIR>/warren\templates\default\main\main.mbt:2:14-2:15:
  | ///|
...
<WORKDIR>/warren\templates\default\main\main.mbt:34:15-34:16:
   |             ),
   |             li <| [
   |               text("Explore "),
34 |               a(
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'button' --loc 'warren\templates\default\main\main.mbt:2:17'
Found 2 references for symbol 'button':
<WORKDIR>/warren\templates\default\main\main.mbt:2:17-2:23:
  | ///|
2 | using @html {a, button, div, h1, h2, li, text, ul}
  |                 ^^^^^^
  | 
...
<WORKDIR>/warren\templates\default\main\main.mbt:25:9-25:15:
   |       div(class="app") <| [
   |         h1(class="title", "Hello Rabbita"),
   |         div(class="lead", "You built it successfully!"),
25 |         button(class="click-btn", on_click=emit(Clicked), "You clicked \{count} times"),
   |         ^^^^^^
   |         div(class="next") <| [
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'copy' --loc 'warren\utils.mbt:2:14'
Found 6 references for symbol 'copy':
<WORKDIR>/warren\build.mbt:88:5-88:9:
   | ///|
   | async fn copy_dir_contents(src : SourcePath, dst : SourcePath) -> Unit {
   |   for entry in @fs.readdir(source_path_to_string(src), sort=true) {
88 |     copy(src=src.join(entry), dst=dst.join(entry))
   |     ^^^^
   |   }
   | }

<WORKDIR>/warren\build.mbt:192:5-192:9:
...
<WORKDIR>/warren\build.mbt:205:5-205:9:
    |     ) else {
    |       return
    |     }
205 |     copy(src~, dst~)
...
<WORKDIR>/warren\build.mbt:212:3-212:7:
    |   log(
    |     "warn", "terser not found and node/npm unavailable. Using Moon release JS without extra minification.",
    |   )
212 |   copy(src~, dst~)
...
<WORKDIR>/warren\utils.mbt:2:14-2:18:
  | ///|
2 | pub async fn copy(src~ : SourcePath, dst~ : SourcePath) -> Unit {
  |              ^^^^
  |   let src_str = "\{src}"
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'src' --loc 'warren\utils.mbt:2:19'
Found 9 references for symbol 'src':
<WORKDIR>/warren\build.mbt:88:10-88:13:
   | ///|
   | async fn copy_dir_contents(src : SourcePath, dst : SourcePath) -> Unit {
   |   for entry in @fs.readdir(source_path_to_string(src), sort=true) {
88 |     copy(src=src.join(entry), dst=dst.join(entry))
...
<WORKDIR>/warren\build.mbt:192:10-192:14:
    |     guard !run_minifier("terser", terser_args, mod_root, "terser") else {
    |       return
    |     }
192 |     copy(src~, dst~)
...
<WORKDIR>/warren\build.mbt:205:10-205:14:
    |     ) else {
    |       return
    |     }
205 |     copy(src~, dst~)
...
<WORKDIR>/warren\build.mbt:212:8-212:12:
    |   log(
    |     "warn", "terser not found and node/npm unavailable. Using Moon release JS without extra minification.",
    |   )
212 |   copy(src~, dst~)
...
<WORKDIR>/warren\utils.mbt:2:19-2:22:
  | ///|
2 | pub async fn copy(src~ : SourcePath, dst~ : SourcePath) -> Unit {
  |                   ^^^
  |   let src_str = "\{src}"
...
<WORKDIR>/warren\utils.mbt:3:20-3:23:
  | ///|
...
<WORKDIR>/warren\utils.mbt:5:72-5:75:
  | pub async fn copy(src~ : SourcePath, dst~ : SourcePath) -> Unit {
  |   let src_str = "\{src}"
  |   let dst_str = "\{dst}"
5 |   guard @fs.exists(src_str) else { fail("Source path does not exist: \{src}") }
  |                                                                        ^^^
  |   if @fs.kind(src_str) is Directory {
  |     @fs.mkdir(dst_str, permission=0o755, recursive=true)

<WORKDIR>/warren\utils.mbt:9:12-9:15:
  |   if @fs.kind(src_str) is Directory {
  |     @fs.mkdir(dst_str, permission=0o755, recursive=true)
  |     for entry in @fs.readdir(src_str, sort=true) {
9 |       copy(src=src.join(entry), dst=dst.join(entry))
...
<WORKDIR>/warren\utils.mbt:9:16-9:19:
  |   if @fs.kind(src_str) is Directory {
  |     @fs.mkdir(dst_str, permission=0o755, recursive=true)
  |     for entry in @fs.readdir(src_str, sort=true) {
9 |       copy(src=src.join(entry), dst=dst.join(entry))
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'new_project_name_placeholder' --loc 'warren\new_project.mbt:2:5'
Found 2 references for symbol 'new_project_name_placeholder':
<WORKDIR>/warren\new_project.mbt:2:5-2:33:
  | ///|
...
<WORKDIR>/warren\new_project.mbt:36:17-36:45:
   | 
   | ///|
   | fn render_new_project_file(content : String, project_name : String) -> String {
36 |   content.split(new_project_name_placeholder).collect().join(project_name)
   |                 ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
   | }
   | 
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'default_new_project_template' --loc 'warren\new_project.mbt:5:5'
Found 2 references for symbol 'default_new_project_template':
<WORKDIR>/warren\main.mbt:172:18-172:46:
    |         Some([dir]) => {
    |           let template = match submatches.values.get("template") {
    |             Some([name]) => name
172 |             _ => default_new_project_template
    |                  ^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    |           }
    |           new_project(dir, template)

<WORKDIR>/warren\new_project.mbt:5:5-5:33:
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'embbed_devtool_js' --loc 'warren\embbed_devtool.mbt:3:5'
Found 2 references for symbol 'embbed_devtool_js':
<WORKDIR>/warren\embbed_devtool.mbt:3:5-3:22:
  | ///|
  | #warnings("-unused_value")
3 | let embbed_devtool_js : String =
  |     ^^^^^^^^^^^^^^^^^
...
<WORKDIR>/warren\main.mbt:303:47-303:64:
    |     )
    |   }
    |   vfs.mount("/index.html", FileContent(shell_html_template))
303 |   vfs.mount("/warren_devtool.js", FileContent(embbed_devtool_js))
    |                                               ^^^^^^^^^^^^^^^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references '_embed_main_mbt' --loc 'warren\templates_bundle.mbt:4:5'
Found 2 references for symbol '_embed_main_mbt':
<WORKDIR>/warren\templates_bundle.mbt:4:5-4:20:
...
<WORKDIR>/warren\templates_bundle.mbt:319:17-319:32:
    | pub let templates : TemplatesFixture = {
    |   default: {
    |     main: {
319 |       main_mbt: _embed_main_mbt,
    |                 ^^^^^^^^^^^^^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references '_embed_moon_pkg' --loc 'warren\templates_bundle.mbt:55:5'
Found 2 references for symbol '_embed_moon_pkg':
<WORKDIR>/warren\templates_bundle.mbt:55:5-55:20:
   |   #|
   | 
   | ///|
...
<WORKDIR>/warren\templates_bundle.mbt:320:17-320:32:
    |   default: {
    |     main: {
    |       main_mbt: _embed_main_mbt,
320 |       moon_pkg: _embed_moon_pkg,
    |                 ^^^^^^^^^^^^^^^
    |     },
    |     public: {
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'Cast' --loc 'rabbita\js\cast.mbt:7:17'
Error: could not find references for symbol 'Cast' at rabbita\js\cast.mbt:7:17
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide find-references 'into' --loc 'rabbita\js\cast.mbt:8:6'
