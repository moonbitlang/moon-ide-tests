...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Cell' --loc 'doc\005_http\using_test.mbt:2:22'
Error: could not get package of loc doc\005_http\using_test.mbt:2:22
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Emit' --loc 'doc\005_http\using_test.mbt:2:33'
Error: could not get package of loc doc\005_http\using_test.mbt:2:33
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Cell' --loc 'doc\001_intro\using_test.mbt:2:22'
Error: could not get package of loc doc\001_intro\using_test.mbt:2:22
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'div' --loc 'doc\001_intro\using_test.mbt:5:14'
Error: could not get package of loc doc\001_intro\using_test.mbt:5:14
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Emit' --loc 'doc\003_router\using_test.mbt:2:22'
Error: could not get package of loc doc\003_router\using_test.mbt:2:22
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Cmd' --loc 'doc\003_router\using_test.mbt:2:33'
Error: could not get package of loc doc\003_router\using_test.mbt:2:33
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Emit' --loc 'doc\002_writing_html\using_test.mbt:2:22'
Error: could not get package of loc doc\002_writing_html\using_test.mbt:2:22
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Html' --loc 'doc\002_writing_html\using_test.mbt:2:33'
Error: could not get package of loc doc\002_writing_html\using_test.mbt:2:33
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Emit' --loc 'doc\004_using_command\using_test.mbt:2:22'
Error: could not get package of loc doc\004_using_command\using_test.mbt:2:22
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Cmd' --loc 'doc\004_using_command\using_test.mbt:2:33'
Error: could not get package of loc doc\004_using_command\using_test.mbt:2:33
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Emit' --loc 'doc\using_subscriptions\using_test.mbt:2:22'
Error: could not get package of loc doc\using_subscriptions\using_test.mbt:2:22
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Cell' --loc 'doc\using_subscriptions\using_test.mbt:2:33'
Error: could not get package of loc doc\using_subscriptions\using_test.mbt:2:33
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'load_shiki' --loc 'utils\shiki\shiki.mbt:2:16'
Error: could not get package of loc utils\shiki\shiki.mbt:2:16
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Promise' --loc 'utils\shiki\shiki.mbt:2:28'
Error: could not get package of loc utils\shiki\shiki.mbt:2:28
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'log' --loc 'warren\log\log.mbt:2:8'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'tag' --loc 'warren\log\log.mbt:2:12'
///|
pub fn log(tag : String, msg : String) -> Unit {
           ^^^
           ```moonbit
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'SourcePath' --loc 'warren\vfs\vfs.mbt:2:19'
///|
using @path {type SourcePath}
                  ^^^^^^^^^^
                  ```moonbit
                  type @path.SourcePath derive(Eq, Compare, Hash)
                  ```
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'VirtualFs' --loc 'warren\vfs\vfs.mbt:5:15'
using @path {type SourcePath}
...
pub(all) enum VirtualFs {
              ...
              ```moonbit
              enum VirtualFs {
                DirectoryMapping(@path.SourcePath)
                FileMapping(@path.SourcePath)
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'ArtifactPath' --loc 'warren\path\artifact_path.mbt:2:8'
///|
struct ArtifactPath {
       ^^^^^^^^^^^^
       ```moonbit
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'root' --loc 'warren\path\artifact_path.mbt:3:3'
///|
struct ArtifactPath {
  root : SourcePath
  ^^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'MooncakesPath' --loc 'warren\path\mooncakeio_path.mbt:2:8'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'MooncakesPath' --loc 'warren\path\mooncakeio_path.mbt:5:8'
struct MooncakesPath(String) derive(Eq, Compare)
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'BroadcastMsg' --loc 'warren\devhub\devhub.mbt:2:15'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Building' --loc 'warren\devhub\devhub.mbt:3:3'
///|
pub(all) enum BroadcastMsg {
  Building
  ^^^^^^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Cmd' --loc 'warren\devtool\main.mbt:2:22'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Emit' --loc 'warren\devtool\main.mbt:2:32'
///|
using @rabbita {type Cmd, type Emit, type Html, delay, new, none}
                               ^^^^
                               ```moonbit
                               type Emit[Msg] = @.Emit[Msg]
                               ```
                               ---
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'log' --loc 'warren\log.mbt:2:4'
///|
fn log(tag : String, msg : String) -> Unit {
   ^^^
   ```moonbit
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'tag' --loc 'warren\log.mbt:2:8'
///|
fn log(tag : String, msg : String) -> Unit {
       ^^^
       ```moonbit
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'SourcePath' --loc 'warren\main.mbt:2:19'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Path' --loc 'warren\main.mbt:2:36'
///|
using @path {type SourcePath, type Path}
                                   ^^^^
                                   ```moonbit
                                   type Path = @moonbitlang/x/path.Path
                                   ```
                                   ---
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'build_entry_script' --loc 'warren\build.mbt:2:5'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'source_path_to_string' --loc 'warren\build.mbt:6:4'
  #|    <script src="./index.js" type="module"></script>
...
fn source_path_to_string(path : SourcePath) -> String {
   ^^^^^^^^^^^^^^^^^^^^^
   ```moonbit
   fn source_path_to_string(path : @path.SourcePath) -> String
   ```
  "\{path}"
}
```
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'a' --loc 'warren\templates\default\main\main.mbt:2:14'
///|
using @html {a, button, div, h1, h2, li, text, ul}
             ^
             ```moonbit
             fn[C : @html.IsChildren] @moonbit-community/rabbita/html.a(style? : Array[String], id? : String, class? : String, title? : String, hidden? : Bool, href~ : String, target? : @html.Target, rel? : String, download? : String, attrs? : @html.Attrs, children : C, escape? : Bool) -> @html.Html
             ```
             ---
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'button' --loc 'warren\templates\default\main\main.mbt:2:17'
///|
using @html {a, button, div, h1, h2, li, text, ul}
                ^^^^^^
                ```moonbit
                fn[C : @html.IsChildren] @moonbit-community/rabbita/html.button(style? : Array[String], id? : String, class? : String, title? : String, hidden? : Bool, type_? : String, disabled? : Bool, name? : String, value? : String, autofocus? : Bool, on_click? : @moonbit-community/rabbita/cmd.Cmd, attrs? : @html.Attrs, children : C) -> @html.Html
                ```
                ---
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'new' --loc 'warren\templates\minimized\main.mbt:1:18'
using @rabbita { new, simple_cell }
                 ^^^
                 ```moonbit
                 fn @moonbit-community/rabbita.new(root : @rabbita.Cell) -> @rabbita.App
                 ```
                 ---
                 
                  Create an application from a root `Cell`.
                 
                  Use `simple_cell()`, `static_cell()`, `cell()`, `cell_with_emit()` to create a cell.
                  ...
                  **For beginners, `simple_cell` is recommended. See its documentation for more details.**
                  ...
                  test "minimal static page" {
                    let app = @rabbita.static_cell(@html.div("hello world"))
                    ignore(app)
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'simple_cell' --loc 'warren\templates\minimized\main.mbt:1:23'
using @rabbita { new, simple_cell }
                      ^^^^^^^^^^^
                      ```moonbit
                      fn[Model, Msg] @moonbit-community/rabbita.simple_cell(model~ : Model, update~ : (Msg, Model) -> Model, view~ : (@moonbit-community/rabbita/cmd.Emit[Msg], Model) -> @html.Html) -> @rabbita.Cell
                      ```
                      ---
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'copy' --loc 'warren\utils.mbt:2:14'
///|
pub async fn copy(src~ : SourcePath, dst~ : SourcePath) -> Unit {
             ^^^^
             ```moonbit
             async fn copy(src~ : @path.SourcePath, dst~ : @path.SourcePath) -> Unit
             ```
  let src_str = "\{src}"
  let dst_str = "\{dst}"
```
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'src' --loc 'warren\utils.mbt:2:19'
///|
pub async fn copy(src~ : SourcePath, dst~ : SourcePath) -> Unit {
                  ^^^
                  ```moonbit
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'new_project_name_placeholder' --loc 'warren\new_project.mbt:2:5'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'default_new_project_template' --loc 'warren\new_project.mbt:5:5'
let new_project_name_placeholder = "__WARREN_PROJECT_NAME__"
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'embbed_devtool_js' --loc 'warren\embbed_devtool.mbt:3:5'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'embbed_devtool_css' --loc 'warren\embbed_devtool.mbt:8:5'
///|
#warnings("-unused_value")
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover '_embed_main_mbt' --loc 'warren\templates_bundle.mbt:4:5'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover '_embed_moon_pkg' --loc 'warren\templates_bundle.mbt:55:5'
  #|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'Cast' --loc 'rabbita\js\cast.mbt:7:17'
No hover information found for symbol 'Cast' at rabbita\js\cast.mbt:7:17
[1]
```

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\rabbita' moon ide hover 'into' --loc 'rabbita\js\cast.mbt:8:6'
No hover information found for symbol 'into' at rabbita\js\cast.mbt:8:6
[1]
```
