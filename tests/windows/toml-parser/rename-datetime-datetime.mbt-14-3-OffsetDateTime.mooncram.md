# toml-parser rename OffsetDateTime datetime\datetime.mbt:14:3

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide rename 'OffsetDateTime' 'OffsetDateTimeRenamed' --loc 'datetime\datetime.mbt:14:3'
*** Begin Patch
