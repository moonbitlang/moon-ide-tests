...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'key_variations_toml' --loc 'additional_official_tests_test.mbt:8:7'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'parse' --loc 'additional_official_tests_test.mbt:17:11'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'result' --loc 'coverage_improvement_comprehensive_test.mbt:9:7'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'parse' --loc 'coverage_improvement_comprehensive_test.mbt:9:22'
Definition found at file <WORKDIR>/parser.mbt
    | /// escapes, inline-table newlines) are accepted.
    | ///
    | /// On any lexical or syntactic error, `parse` raises with a message
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'TomlDateTime' --loc 'datetime\datetime.mbt:13:15'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'OffsetDateTime' --loc 'datetime\datetime.mbt:14:3'
Definition found at file <WORKDIR>/datetime\datetime.mbt
   | ///
   | /// Values are stored as their original string form. The parser preserves
   | /// the spelling supplied in the TOML source; it does not normalize or
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'offset_dt1' --loc 'datetime_extended_test.mbt:4:7'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'OffsetDateTime' --loc 'datetime_extended_test.mbt:4:30'
Definition found at file <WORKDIR>/datetime\datetime.mbt
   | ///
   | /// Values are stored as their original string form. The parser preserves
   | /// the spelling supplied in the TOML source; it does not normalize or
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'tokens' --loc 'internal\tokenize\lexer_test.mbt:4:7'
Definition found at file <WORKDIR>/internal\tokenize\lexer_test.mbt
  | ///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'tokenize' --loc 'internal\tokenize\lexer_test.mbt:4:26'
Definition found at file <WORKDIR>/internal\tokenize\tokenize.mbt
     |   }
     | }
     | 
     | ///|
     | /// Tokenize entire input
1401 | pub fn tokenize(input : String) -> Array[Token] raise {
     |        ^^^^^^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'Loc' --loc 'internal\tokenize\token.mbt:9:17'
Definition found at file <WORKDIR>/internal\tokenize\token.mbt
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'start' --loc 'internal\tokenize\token.mbt:10:3'
Definition found at file <WORKDIR>/internal\tokenize\token.mbt
   | /// is the position immediately after its last character. Two locations are
   | /// `adjacent` (no gap) when one's `end` equals the other's `start`, which
   | /// the parser uses to distinguish e.g. `[[` (array-of-tables) from `[ [`
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'Parser' --loc 'parser.mbt:3:4'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'skip_newlines' --loc 'parser.mbt:3:12'
Definition found at file <WORKDIR>/parser.mbt
  | ///|
  | /// Skip newline tokens
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'tokens' --loc 'parser_wbtest.mbt:7:7'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'tokenize' --loc 'parser_wbtest.mbt:7:26'
Definition found at file <WORKDIR>/internal\tokenize\tokenize.mbt
     |   }
     | }
     | 
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'parse_expect_to_fail' --loc 'test_utils_test.mbt:2:4'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'input' --loc 'test_utils_test.mbt:2:25'
Definition found at file <WORKDIR>/test_utils_test.mbt
  | ///|
2 | fn parse_expect_to_fail(input : String) -> String {
  |                         ^^^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 'escape_toml_string' --loc 'toml_to_string.mbt:3:4'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide peek-def 's' --loc 'toml_to_string.mbt:3:23'
Definition found at file <WORKDIR>/toml_to_string.mbt
  | ///|
  | /// Helper function to escape strings according to TOML spec
3 | fn escape_toml_string(s : String) -> String {
