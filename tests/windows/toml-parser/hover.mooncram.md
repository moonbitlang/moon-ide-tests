...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'key_variations_toml' --loc 'additional_official_tests_test.mbt:8:7'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'parse' --loc 'additional_official_tests_test.mbt:17:11'
    #|"ʎǝʞ" = "value"
    #|
  debug_inspect(
    ...
    ^^^^^^^^^^^
    ```moonbit
    fn @moonbit-community/toml.parse(input : String) -> @toml.TomlValue raise
    ```
    ---
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'result' --loc 'coverage_improvement_comprehensive_test.mbt:9:7'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'parse' --loc 'coverage_improvement_comprehensive_test.mbt:9:22'
/// Test EOF handling in parser - covered by creating empty token arrays
test "parser_eof_handling" {
  // Test empty parse input to exercise EOF conditions
  let result = @toml.parse(
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'TomlDateTime' --loc 'datetime\datetime.mbt:13:15'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'OffsetDateTime' --loc 'datetime\datetime.mbt:14:3'
/// the spelling supplied in the TOML source; it does not normalize or
/// validate the underlying calendar arithmetic.
pub(all) enum TomlDateTime {
  OffsetDateTime(String)
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'offset_dt1' --loc 'datetime_extended_test.mbt:4:7'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'OffsetDateTime' --loc 'datetime_extended_test.mbt:4:30'
///|
/// Extended datetime tests for improved coverage
test "test TomlDateTime types and equality" {
  let offset_dt1 = @datetime.OffsetDateTime("1979-05-27T07:32:00Z")
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'tokens' --loc 'internal\tokenize\lexer_test.mbt:4:7'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'tokenize' --loc 'internal\tokenize\lexer_test.mbt:4:26'
///|
/// Tests for the TOML lexer
test "tokenize simple key-value" {
  let tokens = @tokenize.tokenize(
               ^^^^^^^^^^^^^^^^^^
               ```moonbit
               fn @moonbit-community/toml/internal/tokenize.tokenize(input : String) -> Array[@tokenize.Token] raise
               ```
               ---
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'Loc' --loc 'internal\tokenize\token.mbt:9:17'
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'start' --loc 'internal\tokenize\token.mbt:10:3'
/// the parser uses to distinguish e.g. `[[` (array-of-tables) from `[ [`
/// (a nested array literal opening a normal table header).
pub(all) struct Loc {
  start : @lexer.Position
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'Parser' --loc 'parser.mbt:3:4'
///|
/// Skip newline tokens
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'skip_newlines' --loc 'parser.mbt:3:12'
///|
/// Skip newline tokens
fn Parser::skip_newlines(self : Parser) -> Unit {
           ^^^^^^^^^^^^^
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'tokens' --loc 'parser_wbtest.mbt:7:7'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'tokenize' --loc 'parser_wbtest.mbt:7:26'
///|
test "parse_dotted_key - simple identifier" {
  // Test parsing a simple identifier key
  let tokens = @tokenize.tokenize("simple")
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'parse_expect_to_fail' --loc 'test_utils_test.mbt:2:4'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'input' --loc 'test_utils_test.mbt:2:25'
///|
fn parse_expect_to_fail(input : String) -> String {
                        ^^^^^
                        ```moonbit
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 'escape_toml_string' --loc 'toml_to_string.mbt:3:4'
///|
...
```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide hover 's' --loc 'toml_to_string.mbt:3:23'
///|
/// Helper function to escape strings according to TOML spec
fn escape_toml_string(s : String) -> String {
                      ^
