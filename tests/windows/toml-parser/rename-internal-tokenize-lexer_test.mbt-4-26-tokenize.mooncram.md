# toml-parser rename tokenize internal\tokenize\lexer_test.mbt:4:26

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide rename 'tokenize' 'tokenize_renamed' --loc 'internal\tokenize\lexer_test.mbt:4:26'
*** Begin Patch
...
*** Update File: <WORKDIR>/internal\tokenize\datetime_lexer_test.mbt
@@
 ///|
...
*** Update File: <WORKDIR>/internal\tokenize\lexer_bug_test.mbt
@@
 ///|
...
*** Update File: <WORKDIR>/internal\tokenize\test_utils_test.mbt
@@
