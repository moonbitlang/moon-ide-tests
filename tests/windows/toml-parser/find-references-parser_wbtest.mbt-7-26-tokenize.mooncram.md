# toml-parser find-references tokenize parser_wbtest.mbt:7:26

```mooncram
$ run_moon_ide '..\..\..\fixtures\repos\toml-parser' moon ide find-references 'tokenize' --loc 'parser_wbtest.mbt:7:26'
