...
```mooncram
$ run_moon_ide moon ide find-references 'IsEvent' --loc 'rabbita/dom/clipboard_event.mbt:8:10'
...
<WORKDIR>/rabbita/dom/toggle_event.mbt:9:10-9:17:
  | 
  | ///|
  | #cfg(target="js")
...
<WORKDIR>/rabbita/dom/transition_event.mbt:9:10-9:17:
  | 
  | ///|
  | #cfg(target="js")
