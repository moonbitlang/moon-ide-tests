...
```mooncram
$ run_moon_ide moon ide find-references 'Cell' --loc 'doc/005_http/using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc/005_http/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'Emit' --loc 'doc/005_http/using_test.mbt:2:33'
Error: could not get package of file <WORKDIR>/doc/005_http/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'Cell' --loc 'doc/001_intro/using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc/001_intro/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'div' --loc 'doc/001_intro/using_test.mbt:5:14'
Error: could not get package of file <WORKDIR>/doc/001_intro/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'Emit' --loc 'doc/003_router/using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc/003_router/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'Cmd' --loc 'doc/003_router/using_test.mbt:2:33'
Error: could not get package of file <WORKDIR>/doc/003_router/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'Emit' --loc 'doc/002_writing_html/using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc/002_writing_html/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'Html' --loc 'doc/002_writing_html/using_test.mbt:2:33'
Error: could not get package of file <WORKDIR>/doc/002_writing_html/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'Emit' --loc 'doc/004_using_command/using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc/004_using_command/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'Cmd' --loc 'doc/004_using_command/using_test.mbt:2:33'
Error: could not get package of file <WORKDIR>/doc/004_using_command/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'Emit' --loc 'doc/using_subscriptions/using_test.mbt:2:22'
Error: could not get package of file <WORKDIR>/doc/using_subscriptions/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'Cell' --loc 'doc/using_subscriptions/using_test.mbt:2:33'
Error: could not get package of file <WORKDIR>/doc/using_subscriptions/using_test.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'load_shiki' --loc 'utils/shiki/shiki.mbt:2:16'
Error: could not get package of file <WORKDIR>/utils/shiki/shiki.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'Promise' --loc 'utils/shiki/shiki.mbt:2:28'
Error: could not get package of file <WORKDIR>/utils/shiki/shiki.mbt
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'log' --loc 'warren/log/log.mbt:2:8'
Found 5 references for symbol 'log':
<WORKDIR>/warren/devhub/devhub.mbt:57:12-57:15:
   | 
...
<WORKDIR>/warren/devhub/devhub.mbt:64:10-64:13:
   |       panic()
   |     }
   | 
64 |     @log.log(
...
<WORKDIR>/warren/devhub/devhub.mbt:69:12-69:15:
   |       "Port \{port} is occupied by previous warren process \{pid}. Killing it...",
   |     )
...
```mooncram
$ run_moon_ide moon ide find-references 'tag' --loc 'warren/log/log.mbt:2:12'
...
```mooncram
$ run_moon_ide moon ide find-references 'SourcePath' --loc 'warren/vfs/vfs.mbt:2:19'
...
```mooncram
$ run_moon_ide moon ide find-references 'VirtualFs' --loc 'warren/vfs/vfs.mbt:5:15'
...
```mooncram
$ run_moon_ide moon ide find-references 'ArtifactPath' --loc 'warren/path/artifact_path.mbt:2:8'
...
```mooncram
$ run_moon_ide moon ide find-references 'root' --loc 'warren/path/artifact_path.mbt:3:3'
...
```mooncram
$ run_moon_ide moon ide find-references 'MooncakesPath' --loc 'warren/path/mooncakeio_path.mbt:2:8'
...
```mooncram
$ run_moon_ide moon ide find-references 'MooncakesPath' --loc 'warren/path/mooncakeio_path.mbt:5:8'
Found 8 references for symbol 'MooncakesPath':
<WORKDIR>/warren/path/artifact_path.mbt:36:9-36:22:
   | ///|
   | pub fn ArtifactPath::join_module_path(
...
```mooncram
$ run_moon_ide moon ide find-references 'BroadcastMsg' --loc 'warren/devhub/devhub.mbt:2:15'
...
```mooncram
$ run_moon_ide moon ide find-references 'Building' --loc 'warren/devhub/devhub.mbt:3:3'
...
```mooncram
$ run_moon_ide moon ide find-references 'Cmd' --loc 'warren/devtool/main.mbt:2:22'
...
```mooncram
$ run_moon_ide moon ide find-references 'Emit' --loc 'warren/devtool/main.mbt:2:32'
...
```mooncram
$ run_moon_ide moon ide find-references 'log' --loc 'warren/log.mbt:2:4'
...
```mooncram
$ run_moon_ide moon ide find-references 'tag' --loc 'warren/log.mbt:2:8'
...
```mooncram
$ run_moon_ide moon ide find-references 'SourcePath' --loc 'warren/main.mbt:2:19'
...
```mooncram
$ run_moon_ide moon ide find-references 'Path' --loc 'warren/main.mbt:2:36'
...
<WORKDIR>/warren/new_project.mbt:57:14-57:18:
...
<WORKDIR>/warren/new_project.mbt:58:16-58:20:
   |   content : String,
   | ) -> Unit {
...
<WORKDIR>/warren/new_project.mbt:77:9-77:13:
   |       let path = if parent == "" {
   |         name
   |       } else {
...
<WORKDIR>/warren/new_project.mbt:91:9-91:13:
   |       } else if parent == "" {
   |         name
   |       } else {
...
<WORKDIR>/warren/new_project.mbt:102:20-102:24:
    | 
    | ///|
...
<WORKDIR>/warren/new_project.mbt:103:22-103:26:
    | ///|
    | async fn new_project(dir : String, template_name : String) -> Unit {
...
```mooncram
$ run_moon_ide moon ide find-references 'build_entry_script' --loc 'warren/build.mbt:2:5'
...
```mooncram
$ run_moon_ide moon ide find-references 'source_path_to_string' --loc 'warren/build.mbt:6:4'
...
```mooncram
$ run_moon_ide moon ide find-references 'a' --loc 'warren/templates/default/main/main.mbt:2:14'
Found 2 references for symbol 'a':
<WORKDIR>/warren/templates/default/main/main.mbt:2:14-2:15:
  | ///|
...
<WORKDIR>/warren/templates/default/main/main.mbt:34:15-34:16:
   |             ),
   |             li <| [
   |               text("Explore "),
34 |               a(
...
```mooncram
$ run_moon_ide moon ide find-references 'button' --loc 'warren/templates/default/main/main.mbt:2:17'
Found 2 references for symbol 'button':
<WORKDIR>/warren/templates/default/main/main.mbt:2:17-2:23:
  | ///|
2 | using @html {a, button, div, h1, h2, li, text, ul}
  |                 ^^^^^^
  | 
...
<WORKDIR>/warren/templates/default/main/main.mbt:25:9-25:15:
   |       div(class="app") <| [
...
```mooncram
$ run_moon_ide moon ide find-references 'copy' --loc 'warren/utils.mbt:2:14'
...
```mooncram
$ run_moon_ide moon ide find-references 'src' --loc 'warren/utils.mbt:2:19'
...
```mooncram
$ run_moon_ide moon ide find-references 'new_project_name_placeholder' --loc 'warren/new_project.mbt:2:5'
Found 2 references for symbol 'new_project_name_placeholder':
<WORKDIR>/warren/new_project.mbt:2:5-2:33:
  | ///|
...
<WORKDIR>/warren/new_project.mbt:36:17-36:45:
   | 
   | ///|
...
```mooncram
$ run_moon_ide moon ide find-references 'default_new_project_template' --loc 'warren/new_project.mbt:5:5'
...
<WORKDIR>/warren/new_project.mbt:5:5-5:33:
...
```mooncram
$ run_moon_ide moon ide find-references 'embbed_devtool_js' --loc 'warren/embbed_devtool.mbt:3:5'
...
```mooncram
$ run_moon_ide moon ide find-references '_embed_main_mbt' --loc 'warren/templates_bundle.mbt:4:5'
Found 2 references for symbol '_embed_main_mbt':
<WORKDIR>/warren/templates_bundle.mbt:4:5-4:20:
...
<WORKDIR>/warren/templates_bundle.mbt:319:17-319:32:
...
```mooncram
$ run_moon_ide moon ide find-references '_embed_moon_pkg' --loc 'warren/templates_bundle.mbt:55:5'
Found 2 references for symbol '_embed_moon_pkg':
<WORKDIR>/warren/templates_bundle.mbt:55:5-55:20:
   |   #|
   | 
   | ///|
...
<WORKDIR>/warren/templates_bundle.mbt:320:17-320:32:
    |   default: {
    |     main: {
...
```mooncram
$ run_moon_ide moon ide find-references 'Cast' --loc 'rabbita/js/cast.mbt:7:17'
Error: could not find references for symbol 'Cast' at rabbita/js/cast.mbt:7:17
[1]
```

```mooncram
$ run_moon_ide moon ide find-references 'into' --loc 'rabbita/js/cast.mbt:8:6'
