# toml-parser rename tokenize internal/tokenize/lexer_test.mbt:4:26
...
```mooncram
$ run_moon_ide moon ide rename 'tokenize' 'tokenize_renamed' --loc 'internal/tokenize/lexer_test.mbt:4:26'
*** Begin Patch
