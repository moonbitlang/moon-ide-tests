...
```mooncram
$ run_moon_ide moon ide rename 'Reverse' 'ReverseRenamed' --loc 'cmp/cmp.mbt:35:17'
*** Begin Patch
...
```mooncram
$ run_moon_ide moon ide rename 'T' 'TRenamed' --loc 'cmp/cmp.mbt:35:28'
Error: cannot rename symbol 'T' in package '' outside of module 'moonbitlang/core'
[1]
```

```mooncram
$ run_moon_ide moon ide rename 'args' 'args_renamed' --loc 'env/env.mbt:17:8'
*** Begin Patch
...
```mooncram
$ run_moon_ide moon ide rename 'get_cli_args_internal' 'get_cli_args_internal_renamed' --loc 'env/env.mbt:18:3'
*** Begin Patch
*** Update File: <WORKDIR>/env/env.mbt
@@
 ///|
...
```mooncram
$ run_moon_ide moon ide rename 'get_cli_args_internal' 'get_cli_args_internal_renamed' --loc 'env/env_js.mbt:16:16'
Error: could not find references for symbol 'get_cli_args_internal' at env/env_js.mbt:16:16
[1]
```

```mooncram
$ run_moon_ide moon ide rename 'now_internal' 'now_internal_renamed' --loc 'env/env_js.mbt:26:16'
Error: could not find references for symbol 'now_internal' at env/env_js.mbt:26:16
[1]
```

```mooncram
$ run_moon_ide moon ide rename 'args' 'args_renamed' --loc 'env/env_test.mbt:17:7'
*** Begin Patch
*** Update File: <WORKDIR>/env/env_test.mbt
@@
...
```mooncram
$ run_moon_ide moon ide rename 'args' 'args_renamed' --loc 'env/env_test.mbt:17:19'
*** Begin Patch
*** Update File: <WORKDIR>/argparse/parser.mbt
@@
...
```mooncram
$ run_moon_ide moon ide rename 'begin_create_string' 'begin_create_string_renamed' --loc 'env/env_wasm.mbt:28:4'
*** Begin Patch
*** Update File: <WORKDIR>/env/env_wasm.mbt
@@
...
```mooncram
$ run_moon_ide moon ide rename 'XStringCreateHandle' 'XStringCreateHandleRenamed' --loc 'env/env_wasm.mbt:28:29'
*** Begin Patch
*** Update File: <WORKDIR>/env/env_wasm.mbt
@@
